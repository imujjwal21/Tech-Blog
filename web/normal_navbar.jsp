  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="login_page.jsp"> <span class="fa fa-bell-o"></span>  For Post Blog <span class="sr-only">(current)</span></a>
      </li>
...
<li class="nav-item">
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a href="profile.jsp" class="nav-link" ><span class="fa fa-user-circle"></span>   LearnCode With <%=us.getName() %></a>
       </li>
